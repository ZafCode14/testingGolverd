...
function ClassicEnd({ vendor }: Props) {
  ...
  return (
    <div className="h-full w-full absolute top-0 right-0">
      ...
      {/** Position 2 */}
      <div
        className={`${commonStyle} bottom-[18.5vw] left-[11vw] w-[7vw] h-[12vw] z-20`}
        onClick={() => {
          setProductID(id1);
          setShowProduct(true);
        }}
      ...
      {/** Position 3 */}
      <div
        className={`${commonStyle} bottom-[18.5vw] left-[21vw] w-[7vw] h-[12vw] z-20`}
        onClick={() => {
          setProductID(id2);
          setShowProduct(true);
        }}
      ...
      {/** Position 4 */}
      <div
        className={`${commonStyle} bottom-[18.5vw] left-[31vw] w-[7vw] h-[12vw] z-20`}
        onClick={() => {
          setProductID(id3);
          setShowProduct(true);
        }}
      ...
      {/** Position 6 */}
      <div
        className={`${commonStyle} bottom-[18.5vw] left-[70vw] w-[7vw] h-[12vw] z-20`}
        onClick={() => {
          setProductID(id5);
          setShowProduct(true);
        }}
      ...
      {/** Position 7 */}
      <div
        className={`${commonStyle} bottom-[18.5vw] left-[80vw] w-[7vw] h-[12vw] z-20`}
        onClick={() => {
          setProductID(id6);
          setShowProduct(true);
        }}
      ...
      {/** Position 8 */}
      <div
        className={`${commonStyle} bottom-[18.5vw] left-[90vw] w-[7vw] h-[12vw] z-20`}
        onClick={() => {
          setProductID(id7);
          setShowProduct(true);
        }}
